This code gets a file name and two words from user, modify it and turns it into a PDF file. It is for a specific use but can be modified for different purposes.
